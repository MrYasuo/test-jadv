...
fastify
    .decorate("auth", async (request, reply) => {
    try {
        // @ts-ignore
    ...
    .decorate("loginVnu", async (request, reply) => {
    ...
    fastify.get("/login", 
    // @ts-ignore
    { preHandler: fastify.auth }, async (request, reply) => {
        if (request.user)
    ...
    fastify.post("/login", 
    // @ts-ignore
    { preHandler: fastify.loginVnu }, async (request, reply) => {
        const { username, password } = request.body;
